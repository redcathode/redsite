...
<Picture src={arrayphoto} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="a block of aluminum with three gigantic COB LEDs glued to the top of it"/>
...
<Picture src={jankatronWatercooling} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="todo" />
<Picture src={psuPic} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="todo" />
</div>
...
<Picture src={earlyInstallationReservoir} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="an uncovered plastic bucket filled with water sitting inside a cabinet. there are two latex tubes running from a hole in the top of the cabinet into the bucket, as well as a temperature probe" />
<br />
<Picture src={earlyInstallationTop} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="the top of a cabinet. there's a boost converter wired to an aquarium pump that's sitting in a planter and a couple of giant LEDs mounted to a water cooling block, as well as a benchtop power supply to the far right" />
...
<Picture src={breadboarding} class="blogimage" quality="mid" formats={['avif', 'jxl', 'webp']} alt="a breadboard with an esp32-c3 devboard and some resistors and capacitors wired into it. in the lower half of the image, there's an aluminum watercooling block with some mosfets mounted to it" />
...
<Picture src={cadScreenshot} class="blogimage" alt="OnShape screenshot of a water block holder. there's a rectangular slot on the top, tilted about 30 degrees to the right. there's a pillar going down to the bottom with a couple slots for screws to mount it to the cabinet." quality="mid" formats={['avif', 'jxl', 'webp']} />
<br />
<Picture src={mountedHolder} class="blogimage" alt="the holder, screwed into the top of a cabinet" quality="mid" formats={['avif', 'jxl', 'webp']} />
