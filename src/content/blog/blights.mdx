...
---
okay, 1am red here. i've spent the past few hours migrating this blog over to astro, but i don't really feel like setting up katex rn. for now, enjoy this beautiful and overall incredibly well-written latex:
```
$$
10\mathrm{\,L}
\cdot(60\mathrm{°C} - 20\mathrm{°C})
\cdot\frac{4182\space\mathrm{joules}}{\mathrm{L\cdot °C}} 
\cdot\frac{\mathrm{1\space sec}}{\mathrm{300\space joules}} // THREE HUNDRED SPACE JOULES
